document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      alert('Thank you for contacting YESH LI! We will get back to you within 24 hours.');
      contactForm.reset();
    });
  }
});
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "YESH LI (יש לי) uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7cdf8bcc-53be-4feb-b757-a509cca099d3',
                    name: data.name || '',
                    email: data.email || '',
